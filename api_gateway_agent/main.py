...
def generate_api_gateway(prompt):
...
def receive_from_queue():
    ...
    def callback(ch, method, properties, body):
        ...
        gateway_code = generate_api_gateway("Generate an API gateway in Node.js to handle requests for user and product services.")
        send_to_next_queue(gateway_code, 'approval_queue')
